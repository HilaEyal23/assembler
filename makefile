...
assembler: main.o firstPass.o preprocessor.o macro_list.o symbolList.o assembler.o operation.o secondPass.o utils.o
	gcc -g $(FLAGS) macro_list.o preprocessor.o firstPass.o assembler.o symbolList.o operation.o secondPass.o utils.o main.o -o assembler -lm
