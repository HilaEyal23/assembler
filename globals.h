...
typedef enum dirType{NONE = -1,DATA, STRING, STRUCT, ENTRY, EXTERN, CODE} dirType;
enum ARE {ABSOLUTE, EXTERNAL, RELOCATABLE} ARE;
enum filetypes {FILE_INPUT, FILE_OBJECT, FILE_ENTRY, FILE_EXTERN} filetypes;
